...
class BrowseResourcesPage extends ActionPage implements IManageResourcesPage
{
	/**
	...
	{
		parent::__construct('BrowseResources', 0);
		$this->_presenter = new BrowseResourcesPresenter(
			$this,
	...
	public function ProcessPageLoad()
	{
		...
		$this->Display('browse_resources.tpl');
	}
