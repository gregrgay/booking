...
class BrowseResourcesPresenter extends ActionPresenter
{
	/**
		...
		IAttributeService $attributeService)
	{
		...
		//$this->AddAction(BrowseResourcesActions::ActionAdd, 'Add');
		//$this->AddAction(BrowseResourcesActions::ActionChangeAdmin, 'ChangeAdmin');
		//$this->AddAction(BrowseResourcesActions::ActionChangeConfiguration, 'ChangeConfiguration');
		//$this->AddAction(BrowseResourcesActions::ActionChangeDescription, 'ChangeDescription');
		//$this->AddAction(BrowseResourcesActions::ActionChangeImage, 'ChangeImage');
		//$this->AddAction(BrowseResourcesActions::ActionChangeLocation, 'ChangeLocation');
		//$this->AddAction(BrowseResourcesActions::ActionChangeNotes, 'ChangeNotes');
		//$this->AddAction(BrowseResourcesActions::ActionChangeSchedule, 'ChangeSchedule');
		//$this->AddAction(BrowseResourcesActions::ActionRemoveImage, 'RemoveImage');
		//$this->AddAction(BrowseResourcesActions::ActionRename, 'Rename');
		//$this->AddAction(BrowseResourcesActions::ActionDelete, 'Delete');
		//$this->AddAction(BrowseResourcesActions::ActionTakeOffline, 'TakeOffline');
		//$this->AddAction(BrowseResourcesActions::ActionBringOnline, 'BringOnline');
		//$this->AddAction(BrowseResourcesActions::ActionEnableSubscription, 'EnableSubscription');
		//$this->AddAction(BrowseResourcesActions::ActionDisableSubscription, 'DisableSubscription');
		//$this->AddAction(BrowseResourcesActions::ActionChangeAttributes, 'ChangeAttributes');
		//$this->AddAction(BrowseResourcesActions::ActionChangeSort, 'ChangeSortOrder');
	}

	public function PageLoad()
	{	
/*
		if ($this->page->GetResourceId() != null)
		{
			$resources = $this->resourceRepository->GetList(1, 1, null, null, new SqlFilterEquals(new SqlFilterColumn(TableNames::RESOURCE_ALIAS, ColumnNames::RESOURCE_ID), $this->page->GetResourceId()));
			//$resourceList = $this->resourceRepository->GetResourceList($this->page->GetPageNumber(), $this->page->GetPageSize());
		}
		else
		{
			$resources = $this->resourceRepository->GetList($this->page->GetPageNumber(), $this->page->GetPageSize());
		}

		$this->page->BindResources($resources->Results());
		$this->page->BindPageInfo($resouces->PageInfo());

		$this->page->BindResources($this->resourceRepository->GetResourceList());
		*/
		
		//$resources = $this->resourceRepository->GetResourceList($this->page->GetPageNumber(), $this->page->GetPageSize());
