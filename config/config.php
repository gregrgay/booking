...
$conf['settings']['script.url'] = 'http://localhost/phpScheduleIttest/Web';   	// public URL to the Web directory of this phpScheduleIt instance. this is the URL that appears when you are logging in
 ...
 */
$conf['settings']['install.password'] = 'letmein';
/**
 * Pages
 */
