...
*}
{include file='globalheader.tpl' cssFiles='css/styles.css'}
	...
	<div class="resourceDetails" resourceId="{$id}">
		<div style="float:left;max-width:100%;">
			...
			<div style="float:left; text-align:center; width:340px;">
				...
				{/if}
				 <a href="reservation.php?rid={$id}&sid={$resource->GetScheduleId()}&rd={formatdate date=$date key=url}" title="Reserve {$resource->GetName()|escape}">Reserve this resources</a>
